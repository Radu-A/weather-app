  ...
  return (
    <div className="relative w-40 h-40 flex flex-col items-center">
      ...
      <div className="relative w-50 h-24">
        ...
        <div className="absolute bottom-0 left-4 w-20 h-20 rounded-full bg-blue-100"></div>
        <div className="absolute bottom-0 right-4 w-21 h-21 rounded-full bg-blue-100"></div>
